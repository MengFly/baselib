...
public class CollectionUtil {
    ...
    public static <E> E max(Collection<E> col, Comparator<E> comparator) {
        return col.stream().max(comparator).orElse(null);
    }

    public static <E> E min(Collection<E> col, Comparator<E> comparator) {
        return col.stream().min(comparator).orElse(null);
    }
    ...
    public static <E> E getIndexOfElse(E[] list, int index, E defaultValue) {
        Objects.requireNonNull(list);
