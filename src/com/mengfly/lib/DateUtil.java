...
public class DateUtil {
    ...
    public static Date getBeforeDate(int beforeType, int when) {
        return getCalender(beforeType, -when);
    }

    public static Date getAfterDate(int afterType, int when) {
        return getCalender(afterType, when);
    }

    private static Date getCalender(int type, int when) {
